...
const RoomFilterMobile = ({
  ...
  return (
    <Tabs defaultValue={TAG_GROUPS[0].key} value={selectedGroup} onValueChange={setSelectedGroup} className="space-y-[10px]">
      {/* Tabs List: 카테고리 탭 */}
      ...
      {/* 필터 설정과 태그 리스트 컨테이너 */}
      <div className="mt-4 tb:mt-10 flex items-center justify-between">
        {/* 선택된 태그 리스트 */}
