...
const ProfileSection = () => {
  ...
  return user ? (
    <div className="mx-auto my-20 flex h-40 w-[40.5rem] flex-row items-center gap-20 mb:w-[19rem] tb:my-10 tb:h-auto tb:w-[21.438rem] tb:flex-col tb:gap-4">
      {/* 프로필 이미지와 인증 배지 */}
      ...
      {/* 이름 & 한 줄 소개 */}
      <div className="relative flex h-full w-full max-w-96 flex-col gap-2 mb:w-[19rem] tb:ml-0 tb:h-[4.688rem] tb:w-full tb:items-center">
