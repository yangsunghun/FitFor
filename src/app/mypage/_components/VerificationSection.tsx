...
const VerificationSection = () => {
  ...
  return (
    <>
      <div className="flex flex-col tb:mb-0 lt:p-4">
        ...
        {isPending ? (
          ...
          <div className="mt-6 grid grid-cols-1 grid-cols-3 gap-6 divide-x divide-line-02 mb:max-h-20 mb:gap-0 mb:rounded-lg mb:shadow-[0px_0px_1px_0px_rgba(0,0,0,0.08)] mb:shadow-[0px_0px_8px_0px_rgba(0,0,0,0.12)] tb:gap-4">
            <StatsCard title={titles[0]} value={userPostsStats!.length} className="mb:rounded-r-none" />
            <StatsCard title={titles[1]} value={allStats.likes} className="mb:rounded-none" />
            <StatsCard title={titles[2]} value={allStats.view} className="mb:rounded-l-none" />
          </div>
        )}
      ...
      <div className="mt-20 mb:rounded-lg tb:mt-9 tb:rounded-2xl tb:bg-bg-02 lt:m-4 lt:p-4">
