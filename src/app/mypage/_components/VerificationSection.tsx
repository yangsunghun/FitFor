...
const VerificationSection = ({ isVerified = false }: VerificationSectionProps) => {
  const { userPostsStats, allStats, isPending, isError } = useUserStats();
    ...
    <>
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-3 rounded-2xl text-center">
          <button onClick={handleApplication} className="flex flex-row justify-center gap-2 rounded-2xl bg-black px-6 py-4 text-white">
