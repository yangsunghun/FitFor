...
const BodySizeModal = ({ isOpen, onClose, bodySize, onChange, onSave }: BodySizeModalProps) => {
  ...
  return (
    <ModalItem
      isOpen={isOpen}
      onClose={onClose}
      className="flex w-full max-w-[343px] flex-col items-start justify-start !rounded-2xl p-6 px-4"
    >
      ...
      <Button variant="primary" size="sm" onClick={onSave} className="mt-6 w-full">
        저장하기
      </Button>
    </ModalItem>
  );
