  ...
  <div className="space-y-2">
    ...
    <textarea
      ...
      className={cn(
        ...
        "focus-visible:box-shadow-none h-auto w-full resize-none p-4 text-body font-medium placeholder-text-02 focus:outline-none focus-visible:border-transparent focus-visible:ring-0 mb:px-3 mb:py:2"
      )}
      placeholder={
        isTabletOrSmaller
    ...
    />
    {isMissing && <p className="pt-2 text-title2 font-medium text-status-danger tb:text-body">본문을 입력해주세요.</p>}
  </div>
  );
};
