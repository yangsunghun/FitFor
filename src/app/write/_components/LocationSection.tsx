      ...
      <Tablet>
        <div className="flex cursor-pointer items-center justify-between py-4" onClick={onOpenModal}>
          <div className="flex flex-col gap-1">
            <span className="text-title2 font-medium text-text-04 mb:text-body">위치 찾기</span>
            <span className={`font-medium mb:text-caption ${address ? "text-primary-default" : "text-text-03"}`}>
