...
import { BookmarkSimple, ChatsCircle, House, MagnifyingGlass } from "@phosphor-icons/react";
    ...
    <nav className="fixed bottom-0 z-40 hidden w-full bg-bg-01 text-small text-text-02 tb:block">
      <ul className="flex justify-between">
        <Suspense fallback={<p></p>}>
          ...
          <NavItem href="/chat" location="/chat" icon={<ChatsCircle weight="fill" size={24} />} label="코칭" />
          <NavItem
            href="/bookmark"
            location="/bookmark"
