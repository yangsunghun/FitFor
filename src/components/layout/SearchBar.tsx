  ...
  return (
    <div className="w-[calc(100%-30rem)] max-w-[30rem] tb:w-full tb:max-w-full tb:bg-primary-default tb:px-[4.275%] tb:py-[16px]">
      <form
        ...
        className="relative w-full rounded-lg bg-bg-02 tb:bg-bg-01"
        onBlur={handleInputBlur}
        onFocus={() => setShowDropdown(true)} // 클릭 시 드롭다운 열림
      >
        <button type="submit" className="absolute left-6 top-1/2 -translate-y-1/2 tb:left-[12px]">
        ...
        <input
          ...
          className="h-12 w-full rounded-lg bg-transparent pl-14 pr-2 font-medium outline-black placeholder:text-text-03 tb:h-[44px] tb:pl-[40px] tb:text-body tb:text-text-03"
        />
